...
<Popup trigger={<Button>点我测试</Button>} interactionKind="click" disableScroll="force" hasBackdrop>
...
<Popup trigger={<Button>点我测试</Button>} interactionKind="click" hasBackdrop>
  <div style={{ background: 'var(--ifm-background-surface-color)', padding: 20 }}>
    浮层内容
    <Popup trigger={<Button>点我打开嵌套浮层</Button>} interactionKind="click" hasBackdrop>
